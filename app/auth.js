  ...
  function injectUI() {
    ...
    if (!document.getElementById('lp-auth-overlay')) {
      ...
      ov.innerHTML =
        ...
        + '<p style="font-size:11.5px;color:var(--dim,#A2909B);margin:14px 0 0;line-height:1.5">📩 O link de acesso chega por e-mail. Se não achar na caixa de entrada, <strong>confira o spam</strong>.</p>'
        + '</div>';
