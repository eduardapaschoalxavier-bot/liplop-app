  ...
  async function signInMagic() {
    ...
    if (el) {
      ...
      el.innerHTML =
        ...
        + '<div style="font-size:12.5px;color:var(--mid,#6E5762);line-height:1.5">Confira seu e-mail. Ele costuma cair na caixa de <strong>spam</strong>, então vale dar uma olhada lá também.</div>'
        + '</div>';
    }
  }
