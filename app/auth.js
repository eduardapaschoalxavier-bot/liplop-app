  ...
  function injectUI() {
    ...
    if (!document.getElementById('lp-auth-overlay')) {
      ...
      ov.innerHTML =
        ...
        + '<p style="font-size:11.5px;color:var(--dim,#A2909B);margin:14px 0 0;line-height:1.5">📩 O link chega por e-mail e costuma cair no <strong style="background:rgba(244,114,182,0.28);color:var(--text,#1A0E15);padding:1px 6px;border-radius:5px;white-space:nowrap">spam</strong>. Vale conferir lá também.</p>'
        + '</div>';
